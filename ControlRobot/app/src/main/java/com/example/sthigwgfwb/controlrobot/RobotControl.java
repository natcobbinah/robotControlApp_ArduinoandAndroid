...
public class RobotControl extends ActionBarActivity {
 ...
 /*       Stop.setOnClickListener(new View.OnClickListener() {
    ...
    {
          turnOnLed();
          Toast.makeText(RobotControl.this,"Clicked",Toast.LENGTH_SHORT);
    }
    ...
    public void Reversing(View view)
    {
        MoveBackward();
        Toast.makeText(RobotControl.this,"Clicked",Toast.LENGTH_SHORT);
    }

    public void Lefting(View view)
    {
        MoveLeft();
        Toast.makeText(RobotControl.this,"Clicked",Toast.LENGTH_SHORT);
    }

    public void Righting(View view)
    {
        MoveRight();
        Toast.makeText(RobotControl.this,"Clicked",Toast.LENGTH_SHORT);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_robot_control, menu);
        return true;
    }
